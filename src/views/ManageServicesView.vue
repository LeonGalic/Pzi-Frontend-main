<template>
    ...
    <button class="btn btn-dark mt-3 mb-3" @click="modalOpenCloseHandlerUsluga">
        <i class="fas fa-plus"></i> Dodaj novu uslugu
    </button>
    <ModalDodajUslugu v-if="dodavanjeUsluge" @close="modalOpenCloseHandlerUsluga" @potvrdjeno="UspjesnoSpremljeno"/>
