    ...
    <div class="row g-0" v-if="korisnik.id!=Korisnik.id">
      ...
      <div class="col-md-8">
        <div class="card-body">
          ...
          <button class="btn btn-success" @click="submitRoleChange(korisnik.user_role.id, korisnik.user_role.role_id)">Change role</button>
        </div>
        </div>
      </div>
    </div>
...
methods: {
  ...
  submitRoleChange(userrole_id, role_id){
