    ...
    <NavbarUser :path=Korisnik.putanja :rola=userRole />
      <div class="filter-container justify-content-around mt-3">
        <div class="row">
          ...
          <div class="filter-item col-md-3 col-sm-6">
            <label for="ocjena">Minimalna ocjena:</label>
      ...
      <div v-if="otvorenModalObjava">
          <ModalObjava @close="modalOpenCloseHandlerObjava" :showEditButton="false" :objava="objava" />
      </div>
    <div class="card-container-objava">
    <div class="card card-objava shadow" v-for="(objava, index) in filtriraneObjave" :key="index" @click="modalOpenCloseHandlerObjava(objava)">
